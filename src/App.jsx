        ...
        <Navbar bg="primary" variant="dark" expand="lg">
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              ...
              <Nav.Link activeclassname="active" as={Link} to="/sos" big style={{ color: '#ad0000', fontWeight:"bold" }}>SOS</Nav.Link>
              <Nav.Link activeclassname="active" as={Link} to="/sosguardia" big style={{ color: '#ad0000', fontWeight:"bold" }}>SOS Guardia</Nav.Link>
